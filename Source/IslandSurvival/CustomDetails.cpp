...
//		{
//			return (((Enum)ValueAsByte) == DesiredMode) ? EVisibility::Visible : EVisibility::Collapsed;
//		}
//	}
//
...
EVisibility FCustomDetails::PropertyMatchesBool(TSharedPtr<IPropertyHandle> Property) const
{
	if (Property.IsValid())
	{
		bool Value;
		FPropertyAccess::Result Result = Property->GetValue(/*out*/ Value);

		if (Result == FPropertyAccess::Success)
		{
			return ((Value) ? EVisibility::Visible : EVisibility::Collapsed);
		}
	}
